...
export function createResolveChainTool() {
	return defineTool({
		...
		label: "Resolve Chain",
		description: "Resolve whether an address is BTC, TRON, SOL, EVM, or unknown.",
		promptSnippet: "Detect whether an address belongs to BTC, TRON, SOL, EVM, or is unknown.",
